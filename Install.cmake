...
elseif(${CMAKE_SYSTEM_NAME} MATCHES "Linux")
	...
	if(BUILD_GUI)
		...
		if(BUILD_STATIC)
			install(CODE "
			include(GetPrerequisites)
			get_prerequisites(\"${CMAKE_INSTALL_PREFIX}/bin/librevault-gui\" GUI_DEPENDENCIES 1 1 \"\" \"\")
			foreach(DEPENDENCY_FILE \${GUI_DEPENDENCIES})
				gp_resolve_item(\"${CMAKE_INSTALL_PREFIX}/bin/librevault-gui\" \"\${DEPENDENCY_FILE}\" \"\" \"\" resolved_file)
				file(INSTALL \${resolved_file} DESTINATION ${CMAKE_INSTALL_PREFIX}/lib)
				get_filename_component(file_canonical \${resolved_file} REALPATH)
				file(INSTALL \${file_canonical} DESTINATION ${CMAKE_INSTALL_PREFIX}/lib)
			endforeach()
			" COMPONENT librevault-package)
		endif()
	endif()
