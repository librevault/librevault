...
#	endif()
	if(BUILD_DAEMON)
		...
		list(APPEND INSTALLED_BINARIES $ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_BINDIR}/librevault-daemon)
	endif()
	if(BUILD_GUI)
		...
		list(APPEND INSTALLED_BINARIES $ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_BINDIR}/librevault-gui)
	endif()
	if(BUILD_CLI)
		install(PROGRAMS $<TARGET_FILE:librevault-cli> DESTINATION ${CMAKE_INSTALL_BINDIR})
		list(APPEND INSTALLED_BINARIES $ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_BINDIR}/librevault-cli)
	endif()

	if(INSTALL_BUNDLE)
		# Install Qt5 plugins
		set(BUNDLE_PLUGINS_PATH $ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/${CMAKE_INSTALL_LIBDIR}/qt5/plugins)
		install_qt5_plugin("Qt5::QMinimalIntegrationPlugin" QT_PLUGIN "${BUNDLE_PLUGINS_PATH}")
		...
		message(STATUS "${LIBRARY_SEARCH_PATHS}")
