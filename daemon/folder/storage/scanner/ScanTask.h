...
class ScanTask : public QueuedTask {
 ...
 public:
  ...
  ScanTask(QString abspath, const models::FolderSettings& params, Index* index, IgnoreList* ignore_list,
      QObject* parent);
  virtual ~ScanTask();
 ...
 private:
  ...
  void updateFsattrib();
  void updateChunks();
  ChunkInfo populateChunk(const QByteArray& data, QMap<QByteArray, QByteArray> pt_hmac__iv);
};
