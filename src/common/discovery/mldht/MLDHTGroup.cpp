...
MLDHTGroup::MLDHTGroup(MLDHTProvider *provider, const QByteArray &fgroup, QObject *parent)
    : QObject(parent), provider_(provider), info_hash_(btcompat::getInfoHash(fgroup)), folderid_(fgroup) {
