...
void P2PProvider::add_node(url node_url, std::shared_ptr<ExchangeGroup> group_ptr) {
...
void P2PProvider::on_message(std::shared_ptr<P2PDirectory> dir_ptr, const blob& message_raw) {
